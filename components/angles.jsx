...
import { SetGoal } from "./setGoalAngle";
...
export const AngleData = () => {
  ...
  const stopSearch = () => {
    setSearching(false);
    BluetoothModule.stopDiscoveryR();
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      />
      {searching && (
        <Text style={{ color: colors.foreground }}>Searching...</Text>
      )}
      ...
      <Text style={[styles.angleText, { color: colors.foreground }]}>
        Zeroed X: {zeroedX}{" "}
      </Text>
      <Text style={[styles.angleText, { color: colors.foreground }]}>
        Zeroed Y: {zeroedY}{" "}
